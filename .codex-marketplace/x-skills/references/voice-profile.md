...
Your voice, niche, and rules in one place. Fill this once (or let `x-humanizer` build
it from a few of your real posts), and every writing skill in this X (Twitter) bundle
...
- Emoji:
- Formatting (X (Twitter)): 280 chars per tweet (25k on Premium); threads as numbered posts; 0-1 hashtag
...
Paste 2-4 of your own real X (Twitter) lines or posts that sound most like you. The
